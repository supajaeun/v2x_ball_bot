    ...
    def synced_callback(self, rgb_msg, depth_msg):
        ...
        if score >= 0.3:
            ...
            if p_map:
                ...
                _, ball_msg.is_static = self.tracker.update(0, p_map.point.x, p_map.point.y, rgb_msg.header.stamp.sec)
                ball_array.balls.append(ball_msg)
                markers.markers.append(make_marker(ball_msg, self.publish_frame, self.get_clock().now().to_msg()))
